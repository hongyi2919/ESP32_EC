...
如果原本的 Commit 已經 Push 到 GitHub，需要使用：
...
> ⚠️ `git push --force` 會覆蓋遠端 Commit History。
...
當 Feature Branch 已經完成 Merge 且不再需要，可以刪除。
...
```text
* 8a12c3d (HEAD -> main) merge feature
|\
